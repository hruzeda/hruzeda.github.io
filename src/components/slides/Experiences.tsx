...
export const Experiences = () => {
  return (
    <div>
      ...
      <p>
        I started programming in an advertising agency back in 2010 customizing{' '}
      ...
      <p>
        ...
        consume Web Services via REST and SOAP to integrate with payment systems
        like PayPal.
      </p>
      <p>
      ...
      <p>
        ...
        with the Java conversion team, I wrote a PHP script that, when executed
        in a cron task, distributed internal e-mails to the all employees. I
        also rewrote most of the e-mail templates and the{' '}
      ...
      <p>
        ...
        educational Flash games written in Actionscript 3, Apache Flex and Adobe
        AIR. I was practicing design patterns and tried to create a framework
        the whole team could use to build cross platform 2D tiled games using
        the{' '}
      ...
      <p>
        ...
        and a path finding algorithm using the A* algorithm. Afterwards I ported
        the same code to{' '}
      ...
      <p>
        There was also an alternative solution I wrote, also using the Starling
        Framework, for fake isometric games. It distributed nodes over any
