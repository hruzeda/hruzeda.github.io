...
const IndexPage = () => {
  ...
  const slideChanged = (newSlide: string) => () => {
    setSlide(newSlide)
  }
          ...
          <Inner>
            <LeftNav xs='12' lg='4' className='align-self-center'>
              ...
              <div className='text-center'>
                ...
                <br />
                <Navigation active={slide} onChange={slideChanged} />
              </div>
            </LeftNav>

            <CustomCarousel activeSlide={slide} />
